...
Fake Authentication Attack:
  ...
  Other tools that could be used: wifite & Airgeddon.sh (All Attacks in one tool (Replay, Chopchop, Fragment, Hirte, P0841, Caffe-latte)
